...
process STAR  {
    ...
    file "${sname}_Aligned.sortedByCoord.out.bam" into count
...
process featureCounts {
	...
	"""
 	...
 	mkdir -p  ${CNTDIR}
        ...
        outfile=${CNTDIR}/${projectID}_genename.featureCounts.txt
...
process multiqc_preCount {
    ...
    input:
    val sid from multiqc_fastqc.unique()
